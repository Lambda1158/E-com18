...
export default function Beneficios() {
  return (
    <div className="flex flex-wrap justify-center content-around items-center bg-light h-96 flex-col p-3">
      <h3 className="font-semibold text-2xl">¿Que puedes encontrar?</h3>
      <br />
      <div className="flex">
        <ul>
          <li>
      ...
      <div className="flex justify-end ">
        <video className="flex h-72 flex-wrap" autoPlay loop muted>
